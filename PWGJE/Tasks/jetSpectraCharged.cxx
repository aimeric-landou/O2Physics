...
struct JetSpectraChargedTask {
  ...
  void init(o2::framework::InitContext&)
  {
    ...
    if (doprocessSpectraData || doprocessSpectraMCD || doprocessSpectraMCDWeighted) {
      ...
      registry.add("h_jet_phi", "jet Phi;#varphi; counts", {HistType::kTH1F, {PhiAxis}});
      ...
      registry.add("h2_jet_pt_jet_ntracks", "jet #it{p}_{T,jet} vs. N_{jet tracks}; #it{p}_{T,jet} (GeV/#it{c}); N_{jet, tracks}", {HistType::kTH2F, {jetPtAxis, trackPtAxis}});
                         ...
                         soa::Filtered<soa::Join<aod::JetTracks, aod::JTrackExtras>> const& tracks)
  {
    ...
    registry.fill(HIST("h2_centrality_occupancy"), collision.centrality(), collision.trackOccupancyInTimeRange(), eventWeight);
  ...
  PROCESS_SWITCH(JetSpectraChargedTask, processQCWeighted, "weighted collsions and tracks QC for MCD", true);
